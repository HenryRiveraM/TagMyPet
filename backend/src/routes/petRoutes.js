...
petRoutes.post('/', allowRoles('ADMIN', 'OWNER'), upload.array('fotos', 12), petRules, validate, createPet);
petRoutes.get('/:id', getPet);
petRoutes.put('/:id', allowRoles('ADMIN', 'OWNER'), upload.array('fotos', 12), petRules, validate, updatePet);
