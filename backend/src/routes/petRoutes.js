...
petRoutes.post('/', allowRoles('ADMIN', 'OWNER'), upload.single('foto'), petRules, validate, createPet);
petRoutes.get('/:id', getPet);
petRoutes.put('/:id', allowRoles('ADMIN', 'OWNER'), upload.single('foto'), updatePet);
